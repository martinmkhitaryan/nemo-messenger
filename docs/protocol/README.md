...
| 6. Privacy transport | [06-privacy-transport.md](06-privacy-transport.md) | Complete |
...
Languages and libraries for *this* implementation: [ADR-0028](../decisions/0028-implementation-languages-and-libraries.md). Routes and tables: [ADR-0033](../decisions/0033-local-http-api-and-postgres-schema.md). Client vault: [ADR-0034](../decisions/0034-local-vault-passphrase.md). Crates: [`crates/nemo-wire`](../../crates/nemo-wire) (MIT encodings), [`crates/nemo-server`](../../crates/nemo-server) (MIT delivery, local HTTP, S2S mTLS), [`crates/nemo-core`](../../crates/nemo-core) (AGPL identity, PQXDH, MLS, mailbox envelopes, SQLCipher vault), [`crates/nemo-ffi`](../../crates/nemo-ffi) (AGPL UniFFI). Shell: [`apps/compose`](../../apps/compose). v1.1 (group calls, FCM): [`../v1.1.md`](../v1.1.md). v1.2 (later): [`../v1.2.md`](../v1.2.md).
