...
This document is the HTTP and storage mapping of phases 1–5. It MUST NOT add a server-stored field that those phases did not require. Tor/Arti, cover traffic, Maximum mode, and group calls are listed in [`../v1.1.md`](../v1.1.md) and have no routes here.
