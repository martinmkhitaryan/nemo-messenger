...
class OnDeviceClientTest {
    ...
    fun vaultCreateOpenWrongPassphrase() {
        ...
        val secret = deviceVaultSecret(dir.absolutePath)
    ...
    fun twoVaultsExchangeTextAndFile() {
        ...
        val pass = "correct horse"
        val leftSecret = deviceVaultSecret(leftDir.absolutePath)
        val rightSecret = deviceVaultSecret(rightDir.absolutePath)
    ...
    fun groupInviteAdmitAndRemove() {
        ...
        val pass = "correct horse"
        val alice = NemoClient.createAt(aliceDir.absolutePath, pass, deviceVaultSecret(aliceDir.absolutePath))
        val bob = NemoClient.createAt(bobDir.absolutePath, pass, deviceVaultSecret(bobDir.absolutePath))
        val carol = NemoClient.createAt(carolDir.absolutePath, pass, deviceVaultSecret(carolDir.absolutePath))
        try {
