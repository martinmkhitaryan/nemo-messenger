...
- “Cannot be recovered or exported” copy at create (ADR-0023).
...
Also still out of v1 by README §52: iOS/macOS/web, multi-device, key transparency, group migration.
...
**I5 Android is implemented** (Gradle KMP + CI `assembleDebug`). Leftover code L1–L5 is in. Freeze is a live audible 1:1 and an APK on a device ([`docs/testing.md`](docs/testing.md)), then delete this file and [`REMAINING.md`](REMAINING.md). FCM is I10b and needs ADR-0036.
